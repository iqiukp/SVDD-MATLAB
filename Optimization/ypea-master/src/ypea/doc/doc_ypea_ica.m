...
% Selection Pressure
alg.selection_pressure = 1;

% Assimilation Coefficient
alg.assimilation_coeff = 1.5;

% Revolution Probability
alg.revolution_prob = 0.05;

% Revolution Rate
alg.revolution_rate = 0.1;

% Revolution Step Size
alg.revolution_step_size = 0.1;

% Revolution Step Size Damp Rate
alg.revolution_step_size_damp = 0.99;

% Weight of Colonies in Empire Objetive Value
alg.zeta = 0.2;
